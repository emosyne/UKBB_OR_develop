process R_final_plot {
    ...
    input: 
    // // [Neural_significant_enh_0.5_DOM, 
        // SCZ_Neural_significant_enh_0.5_DOM_clumped_EPWAS_originalOR.summary, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure1.summary, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure2.summary, 
        // SCZ_Neural_significant_enh_0.5_DOM_clumped_EPWAS_originalOR.prsice, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure1.prsice, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure2.prsice,
        // SCZ_Neural_significant_enh_0.5_DOM_clumped_EPWAS_originalOR.best, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure1.best, SCZ_Neural_significant_enh_0.5_DOM_mult_1_clumped_EPWAS_OR_by_measure2.best, 
        // SCZ_Neural_significant_enh_0.5_DOM_clumped_residual_GWAS_compartment.summary, SCZ_Neural_significant_enh_0.5_DOM_clumped_residual_GWAS_compartment.prsice, SCZ_Neural_significant_enh_0.5_DOM_clumped_residual_GWAS_compartment.best, 
        ...
        // Neural_significant_enh, 0.5, SCZ, SCZ_ALLCHR_SCZ_QC.fam, DOM, enh_ES, enh_TS_tpm]
    tuple val(ENHlist_thresh_model), \
        ...
        val(ENH_list), val(CTthreshold), val(condition), path(cohort_fam), val(model), val(modif_name_1),val(modif_name_2)
